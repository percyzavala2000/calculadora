...
export const CalculatorScreen = () => {
 const{number,prevNumber,buildNumber,clear,deleteOperation,togglePositiveNegative,addOperation,divideOperation,multiplyOperation,substractOperation}= useCalculator();
  // render
  return (
